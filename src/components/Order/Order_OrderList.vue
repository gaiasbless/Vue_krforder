<template>
  <div class="w-100 d-flex flex-column flex-grow-1 flex-nowrap p-2">

    <div class="d-flex flex-row">
      <img class="align-text-bottom me-1" src="@bootstrap-icons/icons/Telephone.svg" width="24" height="24">
      <h5><b>발주 목록</b></h5>
    </div>
    ...
    <div class="row mt-3">
      <div class="col-md-auto d-flex flex-row flex-nowrap align-items-center">
        ...
        <button type="button" class="btn btn-sm btn-outline-primary ms-3" v-on:click="DatePicker_Today">오늘</button>
        <button type="button" class="btn btn-sm btn-outline-primary ms-1" v-on:click="DatePicker_Week">이번주</button>
        <button type="button" class="btn btn-sm btn-outline-primary ms-1" v-on:click="DatePicker_Month">이번달</button>
      </div>
      <div class="col d-flex align-items-center justify-content-end">
        <button style="width: 70px" type="button" class="btn btn-sm btn-outline-primary" v-on:click="PrintMainContent" block>인쇄</button>
      </div>
    </div>
