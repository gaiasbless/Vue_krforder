<template>
  <div class="w-100 d-flex flex-column p-2 align-items-center" style="min-width: 900px">
    ...
    <form class="mt-2 px-4" style="width: 900px" v-on:submit.prevent="API_ModifyOrderInfo" autocomplete="off">
      <div class="row mt-1">
        <div class="col p-0">
      ...
      <div class="row mt-2">
        <table class="border border-dark border-2">
          ...
          <tr>
            ...
            <td class="table_cell">{{ NumberFormat( Math.round(OrderInfo[0].Quantity / OrderInfo[0].Quantity_Unit) + (OrderInfo[0].Quantity % OrderInfo[0].Quantity_Unit > 0 ? 1 : 0) ) }}</td>
          </tr>
          <tr>
      ...
      <div class="row mt-4 mb-5">
        <div class="col d-flex align-items-center justify-content-center">
          ...
          <button class="btn btn-outline-secondary px-4 ms-1" type="button" v-on:click="router.go( -1 )">취소</button>
        </div>
      </div>
    </form>
...
<script setup>
  ...
  watch(() => [OrderInfo.value[0].Quantity, OrderInfo.value[0].Quantity_Unit], ( NewValue, OldValue ) => {
    LogManager.w( "Logistics_Store_Detail", "Watch", "Quantity_01 : " + NewValue[0] + " / Quantity_Unit_01 : " + NewValue[1] )
